...
var ObjectType = /*#__PURE__*/function (_MixedType) {
  (0, _inheritsLoose2["default"])(ObjectType, _MixedType);
  ...
  _proto.check = function check(value, data, fieldName) {
    ...
    var check = function check(value, data, type) {
      if (type.required && !(0, _utils.checkRequired)(value, type.trim, type.emptyAllowed)) {
        return {
          hasError: true,
      ...
      if (!type.required && (0, _utils.isEmpty)(value)) {
        return {
          hasError: false
        };
      }
