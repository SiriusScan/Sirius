...
/**
 * SiriusLogo - Combined wolf icon and text logo
 * Can be used with or without text
 */
const SiriusLogo: React.FC<LogoProps> = ({
  className,
  width,
  height = "80px",
  iconFill = "white",
  ...
  return (
    <svg
      ...
      {...props}
    >
      {/* Wolf Icon - scaled and positioned on the left */}
      <g transform="translate(-20, 0) scale(0.25)">
        <path
          fill={iconFill}
