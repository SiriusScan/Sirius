...
interface FileContentStepModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export const FileContentStepModal: React.FC<FileContentStepModalProps> =
    ...
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto border-gray-700 bg-gray-800 text-white">
          <DialogHeader>
            <DialogTitle>
              {editingStep ? "Edit" : "Add"} File Content Search
            </DialogTitle>
...
FileContentStepModal.displayName = "FileContentStepModal";
