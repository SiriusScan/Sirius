...
export const data: SiriusVulnerability = {
  vid: "1",
  cvss: 10,
  description:
    'The SMBv1 server in Microsoft Windows Vista SP2; Windows Server 2008 SP2 and R2 SP1; Windows 7 SP1; Windows 8.1; Windows Server 2012 Gold and R2; Windows RT 8.1; and Windows 10 Gold, 1511, and 1607; and Windows Server 2016 allows remote attackers to execute arbitrary code via crafted packets, aka "Windows SMB Remote Code Execution Vulnerability." This vulnerability is different from those described in CVE-2017-0144, CVE-2017-0145, CVE-2017-0146, and CVE-2017-0148.',
  title: "SMB v1.0 Remote Code Execution",
  severity: "High",
  cve: cveData,
};

export const mockVulnerabilitySummaryData: VulnerabilitySummary[] =  [
  {
    cve: "CVE-2021-34527",
    count: 1,
    cvss: 10,
    description: "A critical issue in the Microsoft Windows operating system printer spooler service allows for remote code execution.",
  ...
  },
  {
    ...
    count: 14,
    cvss: 8.1,
    description: "This vulnerability allows remote code execution if the target system is joined to a domain and is configured to use Group Policy Update.",
